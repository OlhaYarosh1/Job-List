...
const JobComponent = ({ title, address, picture }) => {
    ...
    return (
        ...
        lg:p-0 mb-2 relative lg:bg-boxColor md:bg-boxColor rounded-lg shadow-boxShadow sm:bg-mobile sm:h-mobile'>
            ...
            sm:ml-titleMobileLeft sm:text-starMobile sm:mt-starIconMobile sm:w-starIconMobileBox'>
                <img src='icons/Star.png' alt='' className='bg-transparent inline-block sm:w-starIconMobile md:w-starIcon md:h-starIcon'/>
                <img src='icons/Star.png' alt='' className='bg-transparent inline-block sm:w-starIconMobile md:w-starIcon md:h-starIcon'/>
                <img src='icons/Star.png' alt='' className='bg-transparent inline-block sm:w-starIconMobile md:w-starIcon md:h-starIcon'/>
                <img src='icons/Star.png' alt='' className='bg-transparent inline-block sm:w-starIconMobile md:w-starIcon md:h-starIcon'/>
                <img src='icons/Star.png' alt='' className='bg-transparent inline-block sm:w-starIconMobile md:w-starIcon md:h-starIcon'/>
            ...
            <div className='bg-transparent absolute md:ml-saveL flex justify-end'>
                <img src='icons/Save.png' alt='' className='md:w-4 md:h-5 sm:w-0 sm:h-0 md:mr-saveR md:mt-saveT bg-transparent'/>
            </div>
        </div>
    )
}
